...
var EventHub = /*#__PURE__*/function () {
  ...
  _createClass(EventHub, [{
    key: "boot",
    value: function boot() {
      this.register(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.BEFORE, this.stateHub.onBefore);
      this.register(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.START, this.stateHub.onStart);
      this.register(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.CANCEL, this.stateHub.onCancel);
      this.register(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.UPLOAD, this.stateHub.onUpload);
      this.register(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.DOWNLOAD, this.stateHub.onDownload);
      this.register(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.SUCCESS, this.stateHub.onSuccess);
      this.register(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.ERROR, this.stateHub.onError);
      this.register(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.FINISH, this.stateHub.onFinish);
    }
  }, {
    key: "register",
...
function Request(EventHub, url, method, payload, options) {
  var headers = options.headers,
      axiosOptions = options.axiosOptions,
      forceFormData = options.forceFormData,
      cancelToken = options.cancelToken;
  EventHub.run(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.BEFORE, {
    url: url,
    method: method,
    payload: payload,
    options: options
  });
  var processed = processPayload(url, method, payload, forceFormData);
  var cancelSignal = cancelToken || new AbortController().signal;
  EventHub.run(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.START, {
    url: processed.url,
    method: method,
  ...
  axios__WEBPACK_IMPORTED_MODULE_2___default()(_objectSpread({
    method: method,
    url: processed.url,
    data: method === _Fixed__WEBPACK_IMPORTED_MODULE_0__.Method.GET ? {} : processed.payload,
    signal: cancelSignal,
    ...
    onUploadProgress: function onUploadProgress(progress) {
      ...
      EventHub.run(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.UPLOAD, {
        progress: progress,
    ...
    onDownloadProgress: function onDownloadProgress(progress) {
      if (!(payload instanceof FormData)) return;
      var percentage = Math.round(progress.loaded / progress.total * 100);
      EventHub.run(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.DOWNLOAD, {
        progress: progress,
        percentage: percentage
      });
    }
...
function processPayload(url, method, payload, forceFormData) {
  ...
  if (!(payload instanceof FormData) && method === _Fixed__WEBPACK_IMPORTED_MODULE_0__.Method.GET && Object.keys(payload).length) {
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Object.preventExtensions({
  requestURL: 'http://localhost',
  route: function route(name) {// some way set requestURL
  },
  url: function url(fullUrl) {
...
var State = /*#__PURE__*/function () {
  ...
  _createClass(State, [{
    ...
    get: function get() {
      return !this.busy && Object.keys(this.errors).length > 0;
    }
  }, {
    key: "registerState",
    value: function registerState(name, callable) {
      Object.defineProperty(this, name, {
        get: function get() {
          return callable(this.states);
        },
        writable: false
      });
    }
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _State__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./State */ "./resources/js-new/State.js");
/* harmony import */ var _Event__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Event */ "./resources/js-new/Event.js");
/* harmony import */ var _Fixed__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Fixed */ "./resources/js-new/Fixed.js");
/* harmony import */ var _Router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Router */ "./resources/js-new/Router.js");
/* harmony import */ var _Network__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Network */ "./resources/js-new/Network.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
...
var StateHub = new _State__WEBPACK_IMPORTED_MODULE_0__.default();
var EventHub = new _Event__WEBPACK_IMPORTED_MODULE_1__.default(StateHub);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Object.create(_objectSpread(_objectSpread({
  state: StateHub.states,
  registerState: function registerState(name, callable) {
    return StateHub.registerState(name, callable);
  }
}, _Router__WEBPACK_IMPORTED_MODULE_3__.default), {}, {
  submit: function submit() {
    var method = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _Fixed__WEBPACK_IMPORTED_MODULE_2__.Method.GET;
    ...
    EventHub.register(_Fixed__WEBPACK_IMPORTED_MODULE_2__.LIFE.BEFORE, onBefore);
    EventHub.register(_Fixed__WEBPACK_IMPORTED_MODULE_2__.LIFE.START, onStart);
    EventHub.register(_Fixed__WEBPACK_IMPORTED_MODULE_2__.LIFE.CANCEL, onCancel);
    EventHub.register(_Fixed__WEBPACK_IMPORTED_MODULE_2__.LIFE.SUCCESS, onSuccess);
    EventHub.register(_Fixed__WEBPACK_IMPORTED_MODULE_2__.LIFE.ERROR, onError);
    EventHub.register(_Fixed__WEBPACK_IMPORTED_MODULE_2__.LIFE.FINISH, onFinish);
    (0,_Network__WEBPACK_IMPORTED_MODULE_4__.default)(EventHub, this.requestURL, method, payload, options);
  },
  get: function get(payload, options) {
    return this.submit(_Fixed__WEBPACK_IMPORTED_MODULE_2__.Method.GET, payload, options);
  },
  post: function post(payload, options) {
    return this.submit(_Fixed__WEBPACK_IMPORTED_MODULE_2__.Method.POST, payload, options);
  },
