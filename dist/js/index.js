...
function reactivityManager(_ref, method) {
  ...
  return {
    ...
    initStates: function initStates() {
      var componentIndex = this.boot();
      var componentItem = window._aquastrap.component[componentIndex];
      var stateItemIndex = componentItem.states.findIndex(function (s) {
      ...
      var modify = _objectSpread(_objectSpread({}, componentItem), {}, {
        states: [].concat(_toConsumableArray(componentItem.states), [{
          key: key,
          method: method,
          state: (0,_nx_js_observer_util__WEBPACK_IMPORTED_MODULE_0__.observable)({
            processing: false,
            result: null,
            statusCode: '',
            errors: {},
    ...
    setState: function setState(method, newState) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ processResponseHeader)
/* harmony export */ });
/* harmony import */ var _helper_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helper/util */ "./resources/js/helper/util.js");
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return fetch(url, options).then(function (res) {
              (0,_headerManager__WEBPACK_IMPORTED_MODULE_4__.default)(res, id, key);
              return res;
            }).then(function (data) {
              var status = data.status;
              return data.json().then(function (r) {
                var response = {
                  status: status,
                  data: r
                };
...
/* harmony import */ var _nx_js_observer_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nx-js/observer-util */ "./node_modules/@nx-js/observer-util/dist/es.es5.js");
/* harmony import */ var _helper_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helper/util */ "./resources/js/helper/util.js");
/* harmony import */ var _core_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./core/index */ "./resources/js/core/index.js");
/* harmony import */ var _network_network__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./network/network */ "./resources/js/network/network.js");
/* harmony import */ var _helper_types__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helper/types */ "./resources/js/helper/types.js");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./config */ "./resources/js/config.js");
/* harmony import */ var _core_state__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./core/state */ "./resources/js/core/state.js");
...
window.Aquastrap = {
  onStart: function onStart(callback) {
    (0,_core_index__WEBPACK_IMPORTED_MODULE_2__._setAquaConfig)(_defineProperty({}, _config__WEBPACK_IMPORTED_MODULE_5__.LIFECYCLE_CONFIG_NAME[_helper_types__WEBPACK_IMPORTED_MODULE_4__.XHREvent.START], callback));

    return this;
  },
  onSuccess: function onSuccess(callback) {
    (0,_core_index__WEBPACK_IMPORTED_MODULE_2__._setAquaConfig)(_defineProperty({}, _config__WEBPACK_IMPORTED_MODULE_5__.LIFECYCLE_CONFIG_NAME[_helper_types__WEBPACK_IMPORTED_MODULE_4__.XHREvent.SUCCESS], callback));

    return this;
  },
  onError: function onError(callback) {
    (0,_core_index__WEBPACK_IMPORTED_MODULE_2__._setAquaConfig)(_defineProperty({}, _config__WEBPACK_IMPORTED_MODULE_5__.LIFECYCLE_CONFIG_NAME[_helper_types__WEBPACK_IMPORTED_MODULE_4__.XHREvent.ERROR], callback));

    return this;
  },
  onFinish: function onFinish(callback) {
    (0,_core_index__WEBPACK_IMPORTED_MODULE_2__._setAquaConfig)(_defineProperty({}, _config__WEBPACK_IMPORTED_MODULE_5__.LIFECYCLE_CONFIG_NAME[_helper_types__WEBPACK_IMPORTED_MODULE_4__.XHREvent.FINISH], callback));
...
window._aquaGenerate = function (id, key, componentIngredient, methods) {
  var methodsAccessor = (0,_network_network__WEBPACK_IMPORTED_MODULE_3__._replicatePublicMethods)(id, key, componentIngredient, methods);
...
function resolveHooks(id, key, methodsAccessor) {
  ...
  var _loop = function _loop() {
    ...
    hooks = _objectSpread(_objectSpread({}, hooks), {}, (_objectSpread2 = {}, _mutatorMap = {}, _mutatorMap[name] = _mutatorMap[name] || {}, _mutatorMap[name].get = function () {
      return createHook((0,_core_state__WEBPACK_IMPORTED_MODULE_6__.reactivityManager)({
        id: id,
        key: key
      }, name), networkHandler);
...
function createHook(reactivity, networkHandler) {
  ...
  return {
    ...
    state: _core_state__WEBPACK_IMPORTED_MODULE_6__.initialState,
    submit: function submit(form) {
      var _this = this;

      var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _helper_types__WEBPACK_IMPORTED_MODULE_4__.Method.POST;
      (0,_core_state__WEBPACK_IMPORTED_MODULE_6__.setState)(reactivity, this, {
        processing: true,
        result: null,
        statusCode: '',
        errors: {},
      ...
      networkHandler(form, type, this.state.abortController.signal).then(function (res) {
        (0,_core_state__WEBPACK_IMPORTED_MODULE_6__.setState)(reactivity, _this, {
          statusCode: res.status,
          result: res.data,
          errors: res.status === 422 && (0,_helper_util__WEBPACK_IMPORTED_MODULE_1__._hasProperty)(res.data, 'errors') ? res.data.errors : {},
          message: (0,_helper_util__WEBPACK_IMPORTED_MODULE_1__._hasProperty)(res.data, 'message') ? res.data.message : ''
        });
      })["catch"](function (err) {
        (0,_core_state__WEBPACK_IMPORTED_MODULE_6__.setState)(reactivity, _this, {
    ...
    get: function get(form) {
      this.submit(form, _helper_types__WEBPACK_IMPORTED_MODULE_4__.Method.GET);
    },
    post: function post(form) {
      this.submit(form, _helper_types__WEBPACK_IMPORTED_MODULE_4__.Method.POST);
    },
    put: function put(form) {
      this.submit(form, _helper_types__WEBPACK_IMPORTED_MODULE_4__.Method.PUT);
    },
    patch: function patch(form) {
      this.submit(form, _helper_types__WEBPACK_IMPORTED_MODULE_4__.Method.PATCH);
    },
    "delete": function _delete(form) {
      this.submit(form, _helper_types__WEBPACK_IMPORTED_MODULE_4__.Method.DELETE);
    }
  };
}
...
window._registerAquaConfig = function () {
  ...
  return {
    onStart: function onStart(callback) {
      (0,_core_index__WEBPACK_IMPORTED_MODULE_2__._setAquaConfig)(_defineProperty({}, _config__WEBPACK_IMPORTED_MODULE_5__.LIFECYCLE_CONFIG_NAME[_helper_types__WEBPACK_IMPORTED_MODULE_4__.XHREvent.START], callback), id);

      return this;
    },
    onSuccess: function onSuccess(callback) {
      (0,_core_index__WEBPACK_IMPORTED_MODULE_2__._setAquaConfig)(_defineProperty({}, _config__WEBPACK_IMPORTED_MODULE_5__.LIFECYCLE_CONFIG_NAME[_helper_types__WEBPACK_IMPORTED_MODULE_4__.XHREvent.SUCCESS], callback), id);

      return this;
    },
    onError: function onError(callback) {
      (0,_core_index__WEBPACK_IMPORTED_MODULE_2__._setAquaConfig)(_defineProperty({}, _config__WEBPACK_IMPORTED_MODULE_5__.LIFECYCLE_CONFIG_NAME[_helper_types__WEBPACK_IMPORTED_MODULE_4__.XHREvent.ERROR], callback), id);

      return this;
    },
    onFinish: function onFinish(callback) {
      (0,_core_index__WEBPACK_IMPORTED_MODULE_2__._setAquaConfig)(_defineProperty({}, _config__WEBPACK_IMPORTED_MODULE_5__.LIFECYCLE_CONFIG_NAME[_helper_types__WEBPACK_IMPORTED_MODULE_4__.XHREvent.FINISH], callback), id);
