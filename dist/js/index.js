...
/* harmony export */   "default": () => (/* binding */ Aquastrap)
/* harmony export */ });
/* harmony import */ var _Event__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Event */ "./resources/js-new/Event.js");
...
/* harmony import */ var _State__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./State */ "./resources/js-new/State.js");
/* harmony import */ var _Fixed__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Fixed */ "./resources/js-new/Fixed.js");
/* harmony import */ var _js_helper_util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../js/helper/util */ "./resources/js/helper/util.js");
/* harmony import */ var _Network__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Network */ "./resources/js-new/Network.js");
/* harmony import */ var _RequestConfigure__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./RequestConfigure */ "./resources/js-new/RequestConfigure.js");
...
var Aquastrap = /*#__PURE__*/function () {
  function Aquastrap() {
    ...
    _classCallCheck(this, Aquastrap);

    this.requestURL = requestURL;
    this._stateHub = new _State__WEBPACK_IMPORTED_MODULE_2__.default();
  ...
  _createClass(Aquastrap, [{
    ...
    value: function setRequestOptions() {
      var userOptions = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      this.requestConfig = Object.assign({}, this.requestConfig, {
        options: lodash_fp_merge__WEBPACK_IMPORTED_MODULE_1___default()(this.requestConfig.options, userOptions)
      });
      return this;
    }
  }, {
    ...
    value: function setRequestHooks() {
      ...
      this.requestConfig = Object.assign({}, this.requestConfig, {
        hooks: lodash_fp_merge__WEBPACK_IMPORTED_MODULE_1___default()(this.requestConfig.hooks, userHooks)
      });
      return this;
    }
  }, {
    ...
    value: function submit() {
      var method = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _Fixed__WEBPACK_IMPORTED_MODULE_3__.Method.GET;
      ...
      var _initExtraStateRegistration = function _initExtraStateRegistration(userStates, mainContext) {
        if (userStates.length === 0) return;
        Array.from(userStates).forEach(function (i) {
      ...
      this.state = _objectSpread({}, this._stateHub.state);

      _initExtraStateRegistration(this._userStates, this);

      var EventHub = new _Event__WEBPACK_IMPORTED_MODULE_0__.default(this._stateHub, this); // last moment config & hooks overwrite

      this.setRequestOptions(config.options);
      this.setRequestHooks(config.hooks);
      this.requestConfig = (0,_RequestConfigure__WEBPACK_IMPORTED_MODULE_6__.default)(EventHub, this.requestURL, method, payload, this.requestConfig.options, this.requestConfig.hooks); // register internal state manager callbacks & user hooks

      EventHub.registerInternalHooks();
      EventHub.registerUserHooks(this.requestConfig.hooks);
      EventHub.run(_Fixed__WEBPACK_IMPORTED_MODULE_3__.LIFE.BEFORE, this.requestConfig.options); // XHR BEGIN

      (0,_Network__WEBPACK_IMPORTED_MODULE_5__.default)(EventHub, this.requestConfig.options);
    }
  }, {
    key: "get",
    value: function get() {
      ...
      return this.submit(_Fixed__WEBPACK_IMPORTED_MODULE_3__.Method.GET, payload, config);
    }
  }, {
    key: "post",
    value: function post() {
      ...
      return this.submit(_Fixed__WEBPACK_IMPORTED_MODULE_3__.Method.POST, payload, config);
    }
  }, {
    key: "cancel",
...
var EventHub = /*#__PURE__*/function () {
  ...
  _createClass(EventHub, [{
    ...
    value: function registerUserHooks(hooks) {
      var _hooks$onBefore = hooks.onBefore,
          onBefore = _hooks$onBefore === void 0 ? nothing : _hooks$onBefore,
          _hooks$onStart = hooks.onStart,
          onStart = _hooks$onStart === void 0 ? nothing : _hooks$onStart,
          _hooks$onCancel = hooks.onCancel,
          onCancel = _hooks$onCancel === void 0 ? nothing : _hooks$onCancel,
          _hooks$onSuccess = hooks.onSuccess,
          onSuccess = _hooks$onSuccess === void 0 ? nothing : _hooks$onSuccess,
          _hooks$onError = hooks.onError,
          onError = _hooks$onError === void 0 ? nothing : _hooks$onError,
          _hooks$onFinish = hooks.onFinish,
          onFinish = _hooks$onFinish === void 0 ? nothing : _hooks$onFinish; // register user hooks

      this.register(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.BEFORE, onBefore);
      this.register(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.START, onStart);
      this.register(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.CANCEL, onCancel);
      this.register(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.SUCCESS, onSuccess);
      this.register(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.ERROR, onError);
      this.register(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.FINISH, onFinish);
    }
  }, {
    key: "register",
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(EventHub, options) {
  console.log(options);
  EventHub.run(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.START, options);
  axios__WEBPACK_IMPORTED_MODULE_1___default()(options).then(function (response) {
    ...
    return EventHub.run(_Fixed__WEBPACK_IMPORTED_MODULE_0__.LIFE.FINISH, {});
  });
}

/***/ }),

/***/ "./resources/js-new/RequestConfigure.js":
/*!**********************************************!*\
  !*** ./resources/js-new/RequestConfigure.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _js_helper_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../js/helper/util */ "./resources/js/helper/util.js");
/* harmony import */ var _Fixed__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Fixed */ "./resources/js-new/Fixed.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(EventHub, url) {
  var method = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _Fixed__WEBPACK_IMPORTED_MODULE_2__.Method.GET;
  var payload = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
  var userOptions = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {};
  var userHooks = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : {};
  var processed = processPayload(url, method, payload);
  var cancelToken = (0,_js_helper_util__WEBPACK_IMPORTED_MODULE_1__._hasProperty)(userOptions, cancelToken) ? userOptions.cancelToken : null;
  var signal = !cancelToken && (0,_js_helper_util__WEBPACK_IMPORTED_MODULE_1__._hasProperty)(userOptions, signal) ? userOptions.signal : new AbortController().signal;

  var defaultOptions = _objectSpread(_objectSpread({
    method: method,
    url: processed.url,
    data: method === _Fixed__WEBPACK_IMPORTED_MODULE_2__.Method.GET ? {} : processed.payload
  }, cancelToken ? {
    ...
    headers: _objectSpread(_objectSpread({
      ...
      "X-Requested-With": "XMLHttpRequest" // "X-CSRF-Token": document.querySelector('meta[name="csrf-token"]').content,

    }),
    onUploadProgress: function onUploadProgress(progress) {
      if (!(payload instanceof FormData)) return;
      EventHub.run(_Fixed__WEBPACK_IMPORTED_MODULE_2__.LIFE.UPLOAD, {
        progress: progress
      });
    },
    onDownloadProgress: function onDownloadProgress(progress) {
      if (!(payload instanceof FormData)) return;
      EventHub.run(_Fixed__WEBPACK_IMPORTED_MODULE_2__.LIFE.DOWNLOAD, {
        progress: progress
      });
    }
  });
  ...
  var options = lodash_fp_merge__WEBPACK_IMPORTED_MODULE_0___default()(defaultOptions, userOptions);
  var hooks = lodash_fp_merge__WEBPACK_IMPORTED_MODULE_0___default()(defaultHooks, userHooks);
  return {
    options: options,
    hooks: hooks
  };
...
function processPayload(url, method, payload, forceFormData) {
  if (((0,_js_helper_util__WEBPACK_IMPORTED_MODULE_1__._hasFiles)(payload) || forceFormData) && !(payload instanceof FormData)) {
    payload = (0,_js_helper_util__WEBPACK_IMPORTED_MODULE_1__._objectToFormData)(payload);
  }

  if (!(payload instanceof FormData) && method === _Fixed__WEBPACK_IMPORTED_MODULE_2__.Method.GET && Object.keys(payload).length) {
    url = url.endsWith("/") ? url.slice(0, -1) : url;
    var params = new URLSearchParams(_objectSpread({}, payload));
    url += "?" + params.toString();
  }
...
/*!***********************************!*\
  ...
  \***********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Aquastrap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Aquastrap */ "./resources/js-new/Aquastrap.js");

window._Aquastrap = _Aquastrap__WEBPACK_IMPORTED_MODULE_0__.default;
})();
