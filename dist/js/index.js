...
function processResponseHeader(response) {
  var process = handle(response);
  ...
  return {
    notification: function notification() {
      ...
      if (parsed && (0,_helper_util__WEBPACK_IMPORTED_MODULE_0__._hasProperty)(parsed, 'type') && (0,_helper_util__WEBPACK_IMPORTED_MODULE_0__._hasProperty)(parsed, 'message')) {
        (0,_notify_index__WEBPACK_IMPORTED_MODULE_1__.notify)(parsed);
      }
    }
  };
}
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return fetch(url, options).then(function (res) {
              (0,_headerManager__WEBPACK_IMPORTED_MODULE_4__.default)(res);
              return res;
            }).then(function (data) {
...
function notify(notification) {
  var notificationEvent = new CustomEvent("aqua.notification", {
    detail: _objectSpread({}, notification),
    cancelable: true,
    bubbles: true
  });
...
window._aquaGenerate = function (id, key, componentIngredient, methods) {
  ...
  var _loop = function _loop() {
    ...
    hook = _objectSpread(_objectSpread({}, hook), {}, (_objectSpread2 = {}, _mutatorMap = {}, _mutatorMap[name] = _mutatorMap[name] || {}, _mutatorMap[name].get = function () {
      return {
        processing: false,
        result: null,
        statusCode: '',
        ...
        submit: function submit(form) {
          ...
          networkHandler(form, type, this.abortController.signal).then(function (res) {
            ...
            _this.errors = res.status === 422 && (0,_helper_util__WEBPACK_IMPORTED_MODULE_0__._hasProperty)(res.data, 'errors') ? res.data.errors : {};
          })["catch"](function (err) {
            _this.message = 'Network Request failed !';
          })["finally"](function (_) {
